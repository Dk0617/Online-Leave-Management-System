...
export function normalizeLeave(raw: Raw): LeaveRequest {
  return {
    ...
    dateTimeCorrectedByHod: raw.dateTimeCorrectedByHod as boolean | undefined,
    originalStartDate: raw.originalStartDate as string | undefined,
    originalStartTime: raw.originalStartTime as string | undefined,
    originalEndDate: raw.originalEndDate as string | undefined,
    originalEndTime: raw.originalEndTime as string | undefined,
